...
//     axios
//       .post("http://localhost:5000/api/admin/paket", paketData)
//       .then((response) => {
...
//         <Form.Group className="mb-3">
//           <Form.Label>Batas Maksimal Denda per Hari (Rp)</Form.Label>
//           <Form.Control
//             type="number"
...
const AddPaket = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      ...
      .post("http://localhost:5000/api/admin/paket", preparedData)
      .then((response) => {
        alert("Paket berhasil ditambahkan!");
      })
      .catch((err) => {
